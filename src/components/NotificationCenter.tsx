  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-md w-[92vw] sm:w-[420px] max-h-[85vh] bg-[#0A0E1A] border border-white/20 text-white rounded-3xl p-5 sm:p-6 shadow-2xl overflow-hidden backdrop-blur-2xl flex flex-col z-[200]">
          {/* Header */}
          <DialogHeader className="p-0 border-b border-white/10 pb-4 flex flex-row items-center justify-between space-y-0 text-left">
            <div className="flex items-center gap-2.5">
              <div className="p-2 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400">
                <Bell className="w-4 h-4" />
              </div>
              <DialogTitle className="font-display font-black text-sm uppercase tracking-widest text-white">
                Notificaciones
              </DialogTitle>
            </div>
          ...
          {isProfileIncomplete && (
            <div className="pt-3 border-t border-red-500/30 flex items-center justify-between gap-2">

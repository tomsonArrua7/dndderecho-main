...
// ── Íconos de redes sociales (SVG inline para las que no están en lucide) ──
...
const REDES = [
  {
    label: "Instagram",
    href: "https://instagram.com/dndderecho",
    icon: IconInstagram,
    hoverColor: "hover:bg-gradient-to-br hover:from-purple-600 hover:via-pink-500 hover:to-orange-400",
  },
  {
    label: "YouTube",
    href: "https://youtube.com/@dndderecho",
    icon: IconYoutube,
    hoverColor: "hover:bg-red-600",
  },
  {
    label: "WhatsApp",
    href: "https://wa.me/5492214000000",
    icon: IconWhatsApp,
    hoverColor: "hover:bg-green-600",
  },
  {
    label: "Facebook",
    href: "https://facebook.com/dndderecho",
    icon: IconFacebook,
    hoverColor: "hover:bg-blue-600",
  },
  {
    label: "Twitter / X",
    href: "https://twitter.com/dndderecho",
    icon: IconTwitterX,
    hoverColor: "hover:bg-neutral-800",
  },
  {
    label: "TikTok",
    href: "https://tiktok.com/@dndderecho",
    icon: IconTikTok,
...
export const Footer = () => (
  <footer className="mt-20 border-t border-white/5 bg-background">
    ...
    {/* ── Franja de redes sociales (al tope del footer) ─────────────── */}
    <div className="border-b border-white/8 bg-card/40">
      <div className="container py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap justify-center">
          {REDES.map(({ label, href, icon: Icon, hoverColor }) => (
            <a
              key={label}
              href={href}
              target="_blank"
    ...
    <div className="container py-10 grid gap-8 md:grid-cols-3">
      ...
      <div className="flex items-start gap-3">
        <div
          ...
          style={{ background: "hsl(222 80% 20%)" }}
        >
          <img
            src={logo}
            alt="DND"
        ...
        <div>
          <div className="font-display font-bold text-lg text-white">Agrupación DND</div>
          ...
          <div className="mt-3 inline-flex items-center gap-1.5 px-2 py-1 rounded border border-accent/30 bg-accent/10 text-accent text-[10px] font-bold uppercase tracking-wider">
      ...
      <div>
        <h4 className="font-display font-semibold mb-4 text-xs uppercase tracking-wider text-muted-foreground">
          Plataforma
        </h4>
      ...
      {/* Columna 3: Contacto + email */}
      <div>
        <h4 className="font-display font-semibold mb-4 text-xs uppercase tracking-wider text-muted-foreground">
          Contacto
        </h4>
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          Para consultas académicas, comunicados o sumarte a la agrupación.
        </p>
        <a
          href="mailto:contacto@dndderecho.com.ar"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-white/15 bg-white/5 text-sm text-white/80 hover:text-white hover:bg-white/10 hover:border-white/25 transition-all duration-200"
        >
          <Mail className="h-4 w-4 text-accent" />
          contacto@dndderecho.com.ar
        </a>

        {/* Íconos redes (compactos, repiten la sección de arriba) */}
    ...
    <div className="border-t border-white/6 py-4">
      <div className="container flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground">
        ...
        <span className="text-white/30">Hecho con ❤ para estudiantes de Derecho</span>
      </div>
    </div>
  </footer>
);
